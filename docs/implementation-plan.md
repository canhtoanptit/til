...
8. **Model policy (v3, tiered — owner-approved 2026-08-09):** two project agent types in `.claude/agents/` carry the tiers:
   ...
   - **`phase-standard`** (Opus, `effort: high`) — well-specified mechanical phases against frozen contracts: authoring, restyles, CRUD, wiring. Upcoming: P18 shadcn, P19‥P22 FEAT1, P23‥P26 FEAT2, P6 deploy prep. Sonnet remains available per-dispatch for trivial slices at orchestrator judgment.
